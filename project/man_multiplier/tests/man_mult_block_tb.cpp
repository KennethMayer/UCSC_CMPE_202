...
void advance_half_clock(Vman_mult_block *top) {
...
void advance_clock(Vman_mult_block *top, int nclocks=1) {
...
int main(int argc, char **argv, char **env) {
  ...
  Vman_mult_block* top = new Vman_mult_block;
  ...
  in1 = rand() % 500;
  in2 = rand() % 500;
  top->multiplier_i = in1;
  top->multiplicand_i = in2;
  top->start_i = 1;
  top->clk = rand() & 1;
  top->reset_i = 1;
